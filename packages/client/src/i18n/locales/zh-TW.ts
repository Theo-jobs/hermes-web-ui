export default {
  ...
  chat: {
    ...
    allProfiles: '全部設定',
    gatewayTarget: '目標',
    gatewayTargetPickerTitle: '選擇閘道目標',
    gatewayTargetSearch: '搜尋閘道、空間、設定或模型',
    gatewayTargetEmpty: '沒有符合的閘道目標',
    gatewayTargetFallback: '目前預設',
  ...
  profiles: {
    ...
    runtime: {
      ...
      switchProfile: '切換前端設定',
      gatewayTargetHint: '遠端閘道在這裡作為聊天目標使用，不會執行本機設定重啟。',
      targetSelected: '已切換聊天目標：{name}',
  ...
  gateways: {
    title: '閘道',
    subtitle: '管理本機和遠端閘道目標；密鑰只透過環境變數引用。',
    running: '執行中',
    stopped: '已停止',
    started: '已啟動',
    startFailed: '启动失败',
    ...
    empty: '还没有配置网关或空间。',
    directoryTitle: '閘道目錄',
    directorySubtitle: '共 {count} 個目標；聊天頁會從這裡選擇本地或遠端目標。',
    totalCount: '{count} 個目標',
    localCount: '{count} 個本地',
    remoteCount: '{count} 個遠端/自訂',
    searchPlaceholder: '搜尋閘道、空間、設定或模型',
    searchEmpty: '沒有符合的閘道目標。',
    id: 'ID',
    ...
    provider: 'Provider',
    providerHint: '可選，例如 custom:nas；用於切換目標時鎖定對應模型提供方。',
    endpoint: '端點',
    endpointConfigured: '端點已配置',
    endpointLocal: '本機預設',
    endpointNotConfigured: '未配置端點',
    upstream: '上游地址',
    ...
    invalidProvider: 'Provider 只能包含字母、數字、冒號、底線或連字號。',
