...
jobTriggered: 'Job ejecutado',
  ...
  profiles: {
    ...
    runtime: {
      ...
      gatewayTargetHint: 'Las pasarelas remotas son objetivos de chat aquí; los reinicios locales permanecen separados.',
      targetSelected: 'Objetivo de chat seleccionado: {name}',
