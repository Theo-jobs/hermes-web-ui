export default {
  ...
  chat: {
    ...
    sessionModeBridge: 'Bridge',
    sessionModeApiServer: 'API Server',
  ...
  profiles: {
    ...
    runtime: {
      ...
      gatewayTargetHint: 'Remote gateways are chat targets here; local runtime restart actions stay separate.',
      targetSelected: 'Chat target selected: {name}',
