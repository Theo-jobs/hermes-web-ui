export default {
  ...
  chat: {
    ...
    gatewayTargetPickerTitle: 'Choose gateway target',
    gatewayTargetSearch: 'Search gateway, space, profile, or model',
    gatewayTargetEmpty: 'No gateway targets match',
    gatewayTargetFallback: 'Current default',
...
jobTriggered: 'Job declenche',
  ...
  profiles: {
    ...
    runtime: {
      ...
      switchProfile: 'Changer de profil frontend',
      gatewayTargetHint: 'Les passerelles distantes sont ici des cibles de chat ; les redémarrages locaux restent séparés.',
      targetSelected: 'Cible de chat sélectionnée : {name}',
  ...
  gateways: {
    title: 'Gateways',
    subtitle: 'Manage local and remote gateway targets. Secrets stay in environment variables.',
    running: 'Running',
    stopped: 'Stopped',
    started: 'Started',
    ...
    addSpace: 'Add space',
    refresh: 'Refresh',
    secretHint: 'Raw secrets are never stored here. Put API keys in environment variables and reference the variable name only.',
    empty: 'No gateways or spaces configured yet.',
    directoryTitle: 'Gateway directory',
    directorySubtitle: '{count} targets. Chat uses this directory to choose local or remote targets.',
    totalCount: '{count} targets',
    localCount: '{count} local',
    remoteCount: '{count} remote/custom',
    searchPlaceholder: 'Search gateway, space, profile, or model',
    searchEmpty: 'No gateway targets match.',
    id: 'ID',
    idHint: 'Letters, numbers, underscores, and hyphens.',
    profile: 'Profile',
    profileHint: 'Hermes profile bound to this gateway.',
    type: 'Type',
    typeLocal: 'Local',
    typeRemote: 'Remote',
    typeCustom: 'Custom',
    typeHint: 'Choose how this gateway is reached.',
    displayName: 'Display name',
    displayNameHint: 'Human-readable label shown in the sidebar and sessions.',
    provider: 'Provider',
    providerHint: 'Optional, for example custom:nas. Used to keep target switches bound to the matching model provider.',
    endpoint: 'Endpoint',
    endpointConfigured: 'Endpoint configured',
    endpointLocal: 'Local default',
    endpointNotConfigured: 'Endpoint not configured',
    upstream: 'Upstream',
    upstreamHint: 'Optional http(s) endpoint for remote or custom gateway.',
    defaultModel: 'Default model',
    defaultModelHint: 'Optional model to preselect for this target.',
    spaceId: 'Space ID',
    spaceIdHint: 'Optional workspace/space binding.',
    apiKeyEnv: 'API key env',
    apiKeyEnvHint: 'Environment variable that contains the API key.',
    apiKeyConfigured: 'API key configured',
    apiKeyNotConfigured: 'No API key',
    readonly: 'Read-only',
    readonlyHint: 'Protect seeded or managed gateway entries.',
    editGateway: 'Edit gateway',
    deleteGateway: 'Delete gateway',
    confirmDeleteGateway: 'Delete gateway {id}?',
    testConnection: 'Test',
    testSuccess: 'Gateway health check returned {status}.',
    testFailed: 'Gateway health check failed: {error}',
    saveSuccess: 'Saved',
    saveFailed: 'Save failed',
    deleteSuccess: 'Deleted',
    deleteFailed: 'Delete failed',
    loadFailed: 'Failed to load gateways: {error}',
    invalidName: '{field} must start with a letter or number and only use letters, numbers, underscores, or hyphens.',
    invalidEnv: 'API key env must be a valid environment variable name.',
    invalidProvider: 'Provider can only use letters, numbers, colons, underscores, or hyphens.',
    invalidUpstream: 'Upstream must be an http(s) URL.',
    identitySection: 'Identity',
    identitySectionHint: 'Name and classify the gateway target.',
    connectionSection: 'Connection',
    connectionSectionHint: 'Configure endpoint, model, and credential reference.',
    bindingSection: 'Binding',
    bindingSectionHint: 'Attach the gateway to a profile and optional space.',
    spaceSection: 'Spaces',
    spaceSectionHint: 'Group gateway targets by workspace or context.',
    noSpaces: 'No spaces for this gateway.',
    orphanSpaces: 'Orphan spaces',
    gatewayId: 'Gateway ID',
    gatewayIdHint: 'Gateway this space belongs to.',
    spaceProfile: 'Space profile',
    spaceProfileHint: 'Profile used when opening this space.',
    editSpace: 'Edit space',
    deleteSpace: 'Delete space',
    confirmDeleteSpace: 'Delete space {id}?',
  },
  kanban: {
