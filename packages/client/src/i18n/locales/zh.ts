export default {
  ...
  chat: {
    ...
    gatewayTarget: '目标',
    gatewayTargetPickerTitle: '选择网关目标',
    gatewayTargetSearch: '搜索网关、空间、配置或模型',
    gatewayTargetEmpty: '没有匹配的网关目标',
    gatewayTargetFallback: '当前默认',
  ...
  profiles: {
    ...
    runtime: {
      ...
      restartProfile: '重启配置',
      switchProfile: '切换配置',
      gatewayTargetHint: '远程网关在这里作为聊天目标使用，不会执行本机配置重启。',
      targetSelected: '已切换聊天目标：{name}',
  ...
  gateways: {
    title: '网关',
    subtitle: '管理本地和远程网关目标；密钥只通过环境变量引用。',
    running: '运行中',
    stopped: '已停止',
    started: '已启动',
    startFailed: '启动失败',
    ...
    addSpace: '添加空间',
    refresh: '刷新',
    secretHint: '这里不会保存明文密钥；请把 API Key 放在环境变量中，只填写变量名。',
    empty: '还没有配置网关或空间。',
    directoryTitle: '网关目录',
    directorySubtitle: '共 {count} 个目标；聊天页会从这里选择本地或远程目标。',
    totalCount: '{count} 个目标',
    localCount: '{count} 个本地',
    remoteCount: '{count} 个远程/自定义',
    searchPlaceholder: '搜索网关、空间、配置或模型',
    searchEmpty: '没有匹配的网关目标。',
    id: 'ID',
    idHint: '可使用字母、数字、下划线和连字符。',
    profile: '配置',
    profileHint: '绑定到这个网关的 Hermes profile。',
    type: '类型',
    typeLocal: '本地',
    typeRemote: '远程',
    typeCustom: '自定义',
    typeHint: '选择网关访问方式。',
    displayName: '显示名称',
    displayNameHint: '在侧边栏和会话中显示的名称。',
    provider: 'Provider',
    providerHint: '可选，例如 custom:nas；用于切换目标时锁定对应模型提供方。',
    endpoint: '端点',
    endpointConfigured: '端点已配置',
    endpointLocal: '本地默认',
    endpointNotConfigured: '未配置端点',
    upstream: '上游地址',
    upstreamHint: '远程或自定义网关的 http(s) 地址，可选。',
    defaultModel: '默认模型',
    defaultModelHint: '可选，打开该目标时预选模型。',
    spaceId: '空间 ID',
    spaceIdHint: '可选的工作区/空间绑定。',
    apiKeyEnv: 'API Key 环境变量',
    apiKeyEnvHint: '保存 API Key 的环境变量名。',
    apiKeyConfigured: '已配置 API Key',
    apiKeyNotConfigured: '未配置 API Key',
    readonly: '只读',
    readonlyHint: '保护预置或托管网关。',
    editGateway: '编辑网关',
    deleteGateway: '删除网关',
    confirmDeleteGateway: '删除网关 {id}？',
    testConnection: '测试',
    testSuccess: '网关健康检查返回 {status}。',
    testFailed: '网关健康检查失败：{error}',
    saveSuccess: '已保存',
    saveFailed: '保存失败',
    deleteSuccess: '已删除',
    deleteFailed: '删除失败',
    loadFailed: '加载网关失败：{error}',
    invalidName: '{field} 必须以字母或数字开头，且只能包含字母、数字、下划线或连字符。',
    invalidEnv: 'API Key 环境变量名格式不正确。',
    invalidProvider: 'Provider 只能包含字母、数字、冒号、下划线或连字符。',
    invalidUpstream: '上游地址必须是 http(s) URL。',
    identitySection: '身份',
    identitySectionHint: '命名并分类网关目标。',
    connectionSection: '连接',
    connectionSectionHint: '配置端点、模型和凭据引用。',
    bindingSection: '绑定',
    bindingSectionHint: '把网关绑定到 profile 和可选空间。',
    spaceSection: '空间',
    spaceSectionHint: '按工作区或上下文组织网关目标。',
    noSpaces: '该网关暂无空间。',
    orphanSpaces: '孤立空间',
    gatewayId: '网关 ID',
    gatewayIdHint: '该空间所属网关。',
    spaceProfile: '空间配置',
    spaceProfileHint: '打开该空间时使用的 profile。',
    editSpace: '编辑空间',
    deleteSpace: '删除空间',
    confirmDeleteSpace: '删除空间 {id}？',
  },
