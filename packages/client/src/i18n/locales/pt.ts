...
jobTriggered: 'Job acionado',
  ...
  profiles: {
    ...
    runtime: {
      ...
      switchProfile: 'Alternar perfil frontend',
      gatewayTargetHint: 'Gateways remotos são alvos de chat aqui; reinícios locais permanecem separados.',
      targetSelected: 'Alvo de chat selecionado: {name}',
